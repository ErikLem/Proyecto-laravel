...
@section('title', 'Llenar Formularios')

@section('content_header')
    <h1>Aceptar Formulario Tutor</h1>
@stop
...
@endif
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-body">
                    <div class="mb-3">
                        ...
                        <label for="fecha_declaracion" class="form-label">Fecha: {!! date('Y/m/d', strtotime($formulario->fecha_declaracion)) !!}</label>
                    </div>
                    <div class="mb-3">
    ...
    <form action="{{route('formulario.insert.datos.tutor') }}" method="POST" class="formulario-enviar" enctype="multipart/form-data">
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nombre_tutor_id" id="nombre_tutor_id" value="{{ $formulario->profesors_id }}" hidden>
                    ...
                    <div>
                        ...
                        <br>
                        <label>Si  </label><input type="radio" name="pregunta_tutor_1" value="Si" {{ (old('pregunta_tutor_1') == "Si") ? "checked" : "" }}/>
                        <label>No  </label><input type="radio" name="pregunta_tutor_1" value="No"{{ (old('pregunta_tutor_1') == "No") ? "checked" : "" }}/>
                    </div>
                    <div>
                        <label class="form-label">
                        ...
                        <br>
                        <label>Si  </label><input type="radio" name="pregunta_tutor_2" value="Si" {{ (old('pregunta_tutor_2') == "Si") ? "checked" : "" }}/>
                        <label>No  </label><input type="radio" name="pregunta_tutor_2" value="No" {{ (old('pregunta_tutor_2') == "No") ? "checked" : "" }}/>
                    </div>
                    <div>
                        <label class="form-label">
                        ...
                        <br>
                        <label>Si  </label><input type="radio" name="pregunta_tutor_3" value="Si" {{ (old('pregunta_tutor_3') == "Si") ? "checked" : "" }}/>
                        <label>No  </label><input type="radio" name="pregunta_tutor_3" value="No"{{ (old('pregunta_tutor_3') == "No") ? "checked" : "" }}/>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">
                            Análisis y Recomendaciones respecto de la información presentada:
                        </label>
                        <textarea class="form-control" name="analisis_recomendaciones_tutor">{{old('analisis_recomendaciones_tutor')}}</textarea>
                    </div>
                    <div>
                        <label class="form-label">
                            Horas validadas y sugeridas de convalidación:
                        </label>
                        <input type="text" class="form-control" id="horas_validadas_tutor" name="horas_validadas_tutor" value="{{old('horas_validadas_tutor')}}"/>
                    </div>
                    <div class="mb-3">
                        <label for="fecha_revision_tutor" class="form-label">Fecha de revision: </label>
                        <input type="date" class="form-control" name="fecha_revision_tutor" id="revision_tutor" value="<?php echo date("Y-m-d");?>" readonly="readonly"/>
                    </div>
                    <div class="mb-3">
                        <label for="firma_tutor" class="form-label">Firma: </label>
                        <input type="file" class="form-control" name="firma_tutor" id="firma_tutor" accept="image/*">
                    </div>
                </div>
                </div>
            </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="formulario_id" id="formulario_id" value="{{ $formulario->id }}" hidden>
                            <textarea class="form-control" id="devolucion_tutor" name="devolucion_tutor" rows="4">{{old('devolucion_subdecano')}}</textarea>
                        </div>
