...
@endif
            ...
            <div class="card-header">
                <h2>Aceptar Formulario Miebro de la CPP</h2>
            </div>
     ...
     <form action="{{ route('formulario.insert.miembrocomision') }}" method="POST" class="formulario-enviar" enctype="multipart/form-data">
         @csrf
         @method('put')
            <div class="accordion-item">
                ...
                <div class="accordion-body">
                    ...
                    <br>
                    <div class="alert alert-warning">Recuerde que debe enviar su recomendación sobre la convalidación de este proceso de convalidación</div>
                    
                    <textarea class="form-control" name="recomendacion_miembro_cpp">{{old('recomendacion_miembro_cpp')}}</textarea>
                    <br>
                   {{-- AQUI SE DEBE ENVIAR LA FECHA DE REVISION POR EL MIEMBRO DE LA CPP --}}
                    ...
                    <input type="date" class="form-control" name="fecha_revision_miembrocpp" id="fecha_revision_miembrocpp" value="<?php echo date("Y-m-d");?>" hidden/>
                </div>
               ...
               <div class="accordion-item">
                ...
                <div class="accordion-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="formulario_id" id="formulario_id" value="{{ $formulario->id }}" hidden>
                        <textarea class="form-control" id="devolucion_miembrocpp" name="devolucion_miembrocpp" rows="4">{{old('devolucion_subdecano')}}</textarea>
                    </div>
