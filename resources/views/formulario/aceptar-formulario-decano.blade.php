...
@endif
            ...
            <div class="card-header">
                <h2>Aceptar Formulario Decano</h2>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-body">
                    ...
                    <textarea class="form-control" name="recomendacion_miembro_cpp">{{$formulario->recomendacion_miembro_cpp}}</textarea>
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-body">
                    ...
                    <div class="mb-3">
                        <label for="horas_convalidadas" class="form-label">Horas convalidades: </label>
                        <input type="number" class="form-control" id="horas_convalidas" name="horas_convalidadas" value="{{$formulario->horas_convalidades}}" readonly="readonly">
                    </div>
                    <div class="d-flex gap-2 justify-content-around">
                        <div class="mb-3 flex-fill">
                            <label for="horas_convalidadas_practicas" class="form-label">Prácticas Laborales: </label>
                            <input type="number" class="form-control" id="horas_convalidadas_practicas" name="horas_convalidadas_practicas" value="{{$formulario->horas_convalidades_practicas}}" readonly="readonly">
                        </div>
                        <div class="mb-3 flex-fill">
                            <label for="horas_convalidads_comunitario" class="form-label">Servicio Comunitario: </label>
                            <input type="number" class="form-control" id="horas_convalidadas_comunitario" name="horas_convalidadas_comunitario" value="{{$formulario->horas_convalidades_comunitario}}" readonly="readonly">
                        </div>
                    </div>                    
                    <label class="form-label">
                        Observaciones de la CPP:
                    </label>
                    <textarea class="form-control" name="observaciones_cpp">{{$formulario->observaciones_cpp}}</textarea>
                    <br>
                    <div class="mb-3">
                        <label for="firma_declaracion" class="form-label">Firma revision: </label>
                        <img style="max-width:15%;width:auto;height:auto;" src="{{asset($formulario->firma_cpp)}}" alt="">
                    </div>
                </div>
    ...
    <form action="{{ route('formulario.insert.decano') }}" method="POST" class="formulario-enviar" enctype="multipart/form-data">
        @csrf
        @method('put') 

            <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwelve">
                <button class="accordion-button collapsed" type="button" aria-expanded="true" data-bs-toggle="collapse" data-bs-target="#collapseTwelve" aria-controls="collapseTwelve">
                    11- Certificación
                </button>
                </h2>
                ...
                <div class="accordion-body">
                    <div class="mb-3">
                        <label for="firma_decano" class="form-label">Firma: </label>
                        <input type="file" class="form-control" name="firma_decano" id="firma_decano" accept="image/*">
                    </div>
                    <div class="mb-3">
                        <label for="fecha_revision_decano" class="form-label">Fecha de revision: </label>
                        <input type="date" class="form-control" name="fecha_revision_decano" id="revision_decano" value="<?php echo date("Y-m-d");?>" readonly="readonly"/>
                    </div>
                    {{-- Envio de Id del formulario por hidden --}}
                    <input type="text" class="form-control" name="formulario_id" id="formulario_id" value="{{ $formulario->id }}" hidden> 
                </div>
...
@section('js')
    ...
    <script>
        ...
        $('.formulario-enviar').submit(function(e){
            e.preventDefault();
        Swal.fire({
        title: 'Esta seguro que quiere terminar este proceso de convalidación?',
        text: "Asegurese de haber revisado toda la información",
        icon: 'warning',
